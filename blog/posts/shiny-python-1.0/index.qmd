...
And if you've been waiting on the sidelines, now is a great time to [get in the game](https://shypy-test-center.netlify.app/py/docs/overview.html)!
...
For a comprehensive overview, see the new [component page](https://shypy-test-center.netlify.app/py/components/display-messages/chat/).
...
The generative AI [quickstart](https://shypy-test-center.netlify.app/py/components/display-messages/chat/#ai-quick-start) has a variety of `ai_model` implementations, but we do recommend starting with [LangChain](https://www.langchain.com/), as it helps standardize response generation across different LLMs.
...
Once you have your credentials set up and [run the app](https://shypy-test-center.netlify.app/py/docs/install-create-run.html) and start chatting!
...
To learn how to do more advanced things with `Chat` (e.g., system messages, RAG, etc), check out the [component page](https://shypy-test-center.netlify.app/py/components/display-messages/chat/).
...
Note that the new `shiny.playwright` module is where you can find dozens of "controllers" that make it easy to mimic user interactions with Shiny [components](https://shypy-test-center.netlify.app/py/components/) and assert their expected state.

:::{.py-3}
![](leverage_controllers.mp4){.border .rounded}
:::

For a comprehensive overview of end-to-end testing, see the new article on [End-to-end testing in Shiny](https://shypy-test-center.netlify.app/py/docs/end-to-end-testing.html).
...
Shiny provides two components for rendering data frames: [`DataGrid()`](https://shypy-test-center.netlify.app/py/components/outputs/data-grid/) and [`DataTable()`](https://shypy-test-center.netlify.app/py/components/outputs/data-table/).
...
For a comprehensive overview of new and old data frame features, see the updated articles on [DataGrid](https://shypy-test-center.netlify.app/py/components/outputs/data-grid/) and [DataTable](https://shypy-test-center.netlify.app/py/components/outputs/data-table/).
...
Shiny Express now has support for using Shiny modules, and you can even create Shiny modules using Express syntax. To learn more, see our documentation on [Shiny modules](https://shypy-test-center.netlify.app/py/docs/modules.html){target="_blank"}.
