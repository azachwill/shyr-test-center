...
We've found that tick marks are usually not that helpful on slider inputs, since you get instant feedback above the handle as you drag. If you want them back, you can pass `ticks=True` to [`input_slider()`](https://shyr-test-center.netlify.app/py/api/ui.input_slider.html).
...
- [API documentation](https://shyr-test-center.netlify.app/py/api/render.DataGrid.html)
...
- [API documentation](https://shyr-test-center.netlify.app/py/api/ExTooltip.html)
