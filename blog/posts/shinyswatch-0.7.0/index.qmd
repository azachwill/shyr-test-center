...
shinyswatch brings [Bootstwatch themes](https://bootswatch.com) to [Shiny for Python](https://shypy-test-center.netlify.app/py), allowing you to easily customize the appearance of your Shiny apps with a variety of themes.
