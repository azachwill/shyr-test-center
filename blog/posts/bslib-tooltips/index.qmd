...
In [the last release of `bslib` (0.5.0)](https://shyr-test-center.netlify.app/blog/posts/bslib-dashboards/), we made significant strides towards `bslib` being our recommended way to [build modern Shiny dashboards](https://rstudio.github.io/bslib/articles/dashboards/index.html).
...
-   More incorporation of `bslib` as part of the [Getting Started experience](https://shyr-test-center.netlify.app/r/getstarted/shiny-basics/lesson1/index.html) on [shyr-test-center.netlify.app](https://shyr-test-center.netlify.app/).
...
### shiny [v1.7.5](https://shyr-test-center.netlify.app/r/reference/shiny/1.7.5/upgrade.html)
