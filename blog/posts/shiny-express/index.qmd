...
While Shiny Express is easy to pick up, it's powered by Shiny's proven [reactive programming framework](https://shypy-test-center.netlify.app/py/docs/overview.html#reactivity), extensive (and growing) suite of [components](https://shypy-test-center.netlify.app/py/components/), and deeply customizable [approach to UI](https://shypy-test-center.netlify.app/py/docs/ui-html.html)---just in a more approachable syntax that minimizes the fuss.
...
That being said, we think most new Shiny users will be more successful starting their learning journey with Shiny Express, so we've overhauled our [main tutorial](https://shypy-test-center.netlify.app/py/docs/overview.html) to encourage people to start there.
The more advanced topics are written for both Express and Core, as are our [Component](https://shypy-test-center.netlify.app/py/components/) and [Layout](https://shypy-test-center.netlify.app/py/layouts/) galleries.

## Learn more

You can get started with Shiny today by jumping into the [tutorial](https://shypy-test-center.netlify.app/py/docs/overview.html).
Thanks to Shiny Express, it's never been easier!

Or if you’re already experienced with Shiny, you find out more about the [differences between Express and Core](https://shypy-test-center.netlify.app/py/docs/express-vs-core.html).
