...
One of the most exciting new features in this release is the ability to make your [`DataTable`](https://shypy-test-center.netlify.app/py/api/core/render.DataTable.html) and [`DataGrid`](https://shypy-test-center.netlify.app/py/api/core/render.DataGrid.html) components editable.
...
([Link](https://shypy-test-center.netlify.app/py/api/core/render.data_frame.html#methods) to data frame renderer helper methods and attributes.)
...
The `shiny create` CLI command now includes additional templates and an option to open the new [Shiny Templates website](https://shypy-test-center.netlify.app/py/templates/) where you can find templates to quickly jump start your app.
