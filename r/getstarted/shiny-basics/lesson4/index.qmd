...
::: { .border .my-5 }
![](images/censusviz.png){ title="Census visualization app" fig-alt="censusVis Shiny app that creates demographic maps with information from the 2010 US Census" .lightbox }
:::
...
::: { .border .my-5 }
![](images/censusviz-showcase.png){ title="Census visualization - showcase" fig-alt="censusVis Shiny app in showcase mode" .lightbox }
:::
