...
::: {.column-page-right}
![](01_hello.png "Title: Hello Shiny"){fig-alt="A screenshot of a basic Shiny app with a slider input and plot output"}
:::
...
::: {.column-page-right}
![](02_text.png "Title: Tabsets Screenshot"){fig-alt="A screenshot of Shiny Tabsets"}
:::
...
::: {.column-page-right}
![](03_reactivity.png "Title: Reactivity Screenshot"){fig-alt="A screenshot of the Reactivity application"}
:::
