...
![](tokens.png){fig-alt="shinyapps.io dashboard highlighting the Token section in the menu"}
...
![](tokens2.png){fig-alt="Screen to get information to use for setting up rsconnect"}
...
![](runapp.png){fig-alt="Run app button"}
...
![](deploy.png){fig-alt="RStudio IDE with Deploy button highlighted"}
...
![Publish from RStudio](publishshiny.png){fig-alt="Shiny app viewer in the RStudio IDE with the Publish button highlighted"}
...
To learn more about instances and other details of the shinyapps.io architecture, read [Scaling and Performance Tuning](/r/articles/improve/scaling-and-tuning/). The guide will also show you several advanced options for fine tuning the performance of your apps on shinyapps.io.
...
![visibility settings](visibility1.png){fig-alt="Visibility settings for shinyapps.io. Default visibility is Public"}
...
![visibility settings](visibility2.png){fig-alt="Visibility settings for shinyapps.io, with the Add user section highlighted."}
...
![visibility settings](visibility3.png){fig-alt="Screen shot of adding an email address to add a user"}
...
If you currently use the pre-beta authentication scheme, please upgrade to the new system by January 28, 2015 as we will be deprecating support for the old authentication system during the beta.  For instructions on how to upgrade, please read the guide [here](/r/articles/share/migration). 
 ...
 * [Shinyapps.io Overview & Tour](https://vimeo.com/121389764)
