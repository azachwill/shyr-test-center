...
![URL components](url-components.png){fig-alt="Shiny app of a segment with URL components and parsed query string. URL components include 'protocol: http:', 'hostname: 127.0.0.1', 'pathname: /', 'port: 3847', 'search: ?foo=123&bar=somestring'. Parsed query string includes 'foo=123, bar=something'."}
...
![All clientData values](clientdata-all.png){fig-alt="Shiny app of Client Data. Slider bar with number of observations and panel with clientData values."}
...
To learn more about `getCurrentOutputInfo()`, see the [reference page](/r/reference/shiny/latest/getCurrentOutputInfo.html).
