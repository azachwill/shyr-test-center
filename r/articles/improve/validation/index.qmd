...
![Validation error](red-error.png){fig-alt="Validation error with Error: invalid first argument"}
...
![](validation-error.png){fig-alt="Validation error that now says Please select a data set"}
...
![](need-label.png){fig-alt="Validation error that now says data set must be provided"}
...
![](validate-versus-error.png){fig-alt="Validation error that says Error: object foo not found"}
...
![](need-own1.png){fig-alt="Validation app with Data set and a drop down with nothing selected."}

When you select `mtcars` in the select box, the app looks like this:

![](need-own.png){fig-alt="Validation app with Data set and a drop down with mtcars selected and the error message Choose another data set. No mtcars please!"}

When you select another data set, the app displays the table and plot:

![](need-own2.png){fig-alt="Validation app with data set iris selected, and a table and histogram of the iris dataset"}
...
![](need-multiple.png){fig-alt="Validation app with nothing selected for data set and error message Please select a data set. Unrecognized data set. Input is an empty string."}
...
![](need-then.png){fig-alt="Validation app with no data selected and the error message Please select a data set"}
...
![](validation-style1.png){fig-alt="Validation app with mtcars selected and the error message Choose another data set. No mtcars please!, in a green font"}
