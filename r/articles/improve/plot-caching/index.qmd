...
**This document explains how to use `renderCachedPlot()`, which was introduced in Shiny 1.2.0. As of Shiny 1.6.0, we recommend using `renderPlot()` with `bindCache()` instead. Please see the [caching](/r/articles/improve/caching/) article to learn more.**
...
<iframe src="https://gallery.shinyapps.io/136-plot-cache/?showcase=0" frameborder="no" class="w-100" height="500px"></iframe>
...
<iframe src="https://gallery.shinyapps.io/137-plot-cache-key/?showcase=0" frameborder="no"  class="w-100" height="500px"></iframe>
