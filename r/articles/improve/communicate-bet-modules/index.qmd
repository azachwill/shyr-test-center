...
![App Screenshot](app_screenshot.png){fig-alt="Shiny app for Ames Housing Data Explorer. Two boxes with drop down menus for selecting X and Y variables, and two scatterplots."}
