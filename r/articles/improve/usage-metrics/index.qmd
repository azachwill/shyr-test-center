...
The following template adds basic tracking for an application's inputs. The template relies on [Shiny's Javascript events](https://shyr-test-center.netlify.app/articles/js-events.html).
