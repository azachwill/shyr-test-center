...
[<i class="fas fa-play-circle fa-lg" aria-hidden="true"></i> How to use Shiny Modules](https://resources.rstudio.com/shiny-developer-conference/shinydevcon-modules-garrettgrolemund-1080p)
